...
namespace TournamentsEnhanced.Wrappers.CampaignSystem
{
  public class MBCampaignEvents : MBWrapperBase<MBCampaignEvents, CampaignEvents>
  {
    ...
    public virtual void CollectAvailableTutorials(ref List<CampaignTutorial> tutorials) => UnwrappedObject.CollectAvailableTutorials(ref tutorials);
    public virtual void LocationCharactersAreReadyToSpawn(Dictionary<string, int> unusedUsablePointCount) => UnwrappedObject.LocationCharactersAreReadyToSpawn(unusedUsablePointCount);
    public virtual void LocationCharactersSimulated() => UnwrappedObject.LocationCharactersSimulated();
    public virtual void MissionTick(float dt) => UnwrappedObject.MissionTick(dt);
    public virtual void OnAfterMissionStarted(IMission iMission) => UnwrappedObject.OnAfterMissionStarted(iMission);
    public virtual void OnAfterSettlementEntered(MobileParty party, Settlement settlement, Hero hero) => UnwrappedObject.OnAfterSettlementEntered(party, settlement, hero);
    public virtual void OnArmyOverlaySetDirty() => UnwrappedObject.OnArmyOverlaySetDirty();
    public virtual void OnBeforeSave() => UnwrappedObject.OnBeforeSave();
    public virtual void OnCampaignStartUp9() => UnwrappedObject.OnCampaignStartUp9();
    ...
    public virtual void OnGameLoadFinished() => UnwrappedObject.OnGameLoadFinished();
    public virtual void OnGameOver() => UnwrappedObject.OnGameOver();
    public virtual void OnHeroCreated(Hero hero, bool isBornNaturally = false) => UnwrappedObject.OnHeroCreated(hero, isBornNaturally = false);
    public virtual void OnHeroWounded(Hero woundedHero) => UnwrappedObject.OnHeroWounded(woundedHero);
    public virtual void OnIssueUpdated(IssueBase issue, IssueBase.IssueUpdateDetails details, Hero issueSolver = null) => UnwrappedObject.OnIssueUpdated(issue, details, issueSolver = null);
    public virtual void OnMissionEnded(IMission mission) => UnwrappedObject.OnMissionEnded(mission);
    public virtual void OnMissionStarted(IMission mission) => UnwrappedObject.OnMissionStarted(mission);
    public virtual void OnNewGameCreated(CampaignGameStarter campaignGameStarter) => UnwrappedObject.OnNewGameCreated(campaignGameStarter);
    public virtual void OnNewGameCreated2() => UnwrappedObject.OnNewGameCreated2();
    public virtual void OnNewGameCreated3() => UnwrappedObject.OnNewGameCreated3();
    public virtual void OnNewGameCreated4() => UnwrappedObject.OnNewGameCreated4();
    public virtual void OnNewGameCreated5() => UnwrappedObject.OnNewGameCreated5();
    public virtual void OnNewGameCreated6() => UnwrappedObject.OnNewGameCreated6();
    public virtual void OnNewGameCreated7() => UnwrappedObject.OnNewGameCreated7();
    public virtual void OnNewGameCreated8() => UnwrappedObject.OnNewGameCreated8();
    public virtual void OnPartyVisibilityChanged(PartyBase party) => UnwrappedObject.OnPartyVisibilityChanged(party);
    public virtual void OnPlayerBoardGameOver(Hero opposingHero, BoardGameHelper.BoardGameState state) => UnwrappedObject.OnPlayerBoardGameOver(opposingHero, state);
    public virtual void OnPlayerCharacterChanged(Hero newPlayer, MobileParty newMainParty) => UnwrappedObject.OnPlayerCharacterChanged(newPlayer, newMainParty);
    public virtual void OnPlayerDonatedHeroPrisoner(Hero donatedHero, Settlement donatedSettlement) => UnwrappedObject.OnPlayerDonatedHeroPrisoner(donatedHero, donatedSettlement);
    public virtual void OnPlayerEliminatedFromTournament(int round, Town town) => UnwrappedObject.OnPlayerEliminatedFromTournament(round, town);
    public virtual void OnPlayerSiegeStarted() => UnwrappedObject.OnPlayerSiegeStarted();
    public virtual void OnPlayerStartedTournamentMatch(Town town) => UnwrappedObject.OnPlayerStartedTournamentMatch(town);
    public virtual void OnPlayerStartRecruitment(CharacterObject recruitTroopCharacter) => UnwrappedObject.OnPlayerStartRecruitment(recruitTroopCharacter);
    public virtual void OnPlayerStartTalkFromMenu(Hero hero) => UnwrappedObject.OnPlayerStartTalkFromMenu(hero);
    public virtual void OnMainPartyPrisonerRecruited(FlattenedTroopRoster roster) => UnwrappedObject.OnMainPartyPrisonerRecruited(roster);
    public virtual void OnPrisonerReleased(FlattenedTroopRoster roster) => UnwrappedObject.OnPrisonerReleased(roster);
    public virtual void OnPrisonersChangeInSettlement(Settlement settlement) => UnwrappedObject.OnPrisonersChangeInSettlement(settlement);
    public virtual void OnPrisonerTaken(FlattenedTroopRoster roster) => UnwrappedObject.OnPrisonerTaken(roster);
    public virtual void OnSettlementEntered(MobileParty party, Settlement settlement, Hero hero) => UnwrappedObject.OnSettlementEntered(party, settlement, hero);
    public virtual void OnSiegeEventEnded(SiegeEvent siegeEvent) => UnwrappedObject.OnSiegeEventEnded(siegeEvent);
    public virtual void OnSiegeEventStarted(SiegeEvent siegeEvent) => UnwrappedObject.OnSiegeEventStarted(siegeEvent);
    public virtual void OnTick(float dt) => UnwrappedObject.OnTick(dt);
    public virtual void OnTournamentFinished(CharacterObject winner, Town town) => UnwrappedObject.OnTournamentFinished(winner, town);
    public virtual void OnTournamentStarted(Town town) => UnwrappedObject.OnTournamentStarted(town);
    public virtual void OnTutorialCompleted(string tutorial) => UnwrappedObject.OnTutorialCompleted(tutorial);
    public virtual void OnUnitRecruited(CharacterObject character, int amount) => UnwrappedObject.OnUnitRecruited(character, amount);
