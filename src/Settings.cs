...
namespace TournamentsEnhanced
{
  public class TournamentsEnhancedSettings : SettingsBase
  {
    ...
    [SettingProperty("Team 1 Color Index", 0, 157, "Set Team 1's banner color by index value. Check https://bannerlord.party/banner-colors/ for the list of available colors.")]
    [SettingPropertyGroup("Team Tournament Game Mode")]
    public int TeamOneColor { get; set; } = 83;
    [SettingProperty("Team 2 Color Index", 0, 157, "Set Team 2's banner color by index value. Check https://bannerlord.party/banner-colors/ for the list of available colors.")]
    [SettingPropertyGroup("Team Tournament Game Mode")]
    public int TeamTwoColor { get; set; } = 119;
    [SettingProperty("Team 3 Color Index", 0, 157, "Set Team 3's banner color by index value. Check https://bannerlord.party/banner-colors/ for the list of available colors.")]
    [SettingPropertyGroup("Team Tournament Game Mode")]
